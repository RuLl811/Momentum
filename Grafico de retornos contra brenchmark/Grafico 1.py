...
# Import los retornos acumulados de las estrategias con duration de portafolio igual a 1 mes
df_1 = pd.read_csv(r'C:\Users\rumtl\PycharmProjects\Tesis\Momentum strategy\Estrategias\Retornos acumulados de las estrategias/3,1.csv', index_col='Date', parse_dates=True)
df_2 = pd.read_csv(r'C:\Users\rumtl\PycharmProjects\Tesis\Momentum strategy\Estrategias\Retornos acumulados de las estrategias/6,1.csv', index_col='Date', parse_dates=True)
df_3 = pd.read_csv(r'C:\Users\rumtl\PycharmProjects\Tesis\Momentum strategy\Estrategias\Retornos acumulados de las estrategias/9,1.csv', index_col='Date', parse_dates=True)
