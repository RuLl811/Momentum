...
##################################################################################################################
########### Cross-Sectional Momentum Strategy: Retornos rezagados a 3 meses; 1 meses "Holding Periods" ##########
##################################################################################################################
...
print('\n')
# Calcular la suma de los retornos promedios de 3 meses
...
# Armo los ponderadores: Equal Weight
...
plt.legend()
plt.show()
cewrp_portafolio.to_csv(r'C:\Users\rumtl\PycharmProjects\Tesis\Momentum strategy\Estrategias\Retornos acumulados de las estrategias\3,1.csv')
### End ###
