...
##################################################################################################################
########### Cross-Sectional Momentum Strategy: Retornos rezagados a 9 meses; 9 meses "Holding Periods" ##########
##################################################################################################################
...
end_formation = start_formation + relativedelta(months=9)  # Dia de venta del portafolio
start_mesurement = start_formation - relativedelta(months=10) - relativedelta(days=2)
...
plt.legend()
plt.show()
cewrp_portafolio.to_csv(r'C:\Users\rumtl\PycharmProjects\Tesis\Momentum strategy\Estrategias\Retornos acumulados de las estrategias\9,9.csv')
### End ###
