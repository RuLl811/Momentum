...
##################################################################################################################
########### Cross-Sectional Momentum Strategy: Retornos rezagados a 6 meses; 12 meses "Holding Periods" ##########
##################################################################################################################
...
# Fechas
start_formation = dt.datetime(2020, 12, 31)  # Dia de compra del portafolio
...
SP500 = reader.DataReader('^GSPC', data_source='yahoo', start='2020-12-31', end='2021-12-31')['Adj Close']
...
cewrp_ganadores.plot(label='Equal Weighted Portfolio (Cumul Ret)')
