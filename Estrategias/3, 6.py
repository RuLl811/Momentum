...
##################################################################################################################
########### Cross-Sectional Momentum Strategy: Retornos rezagados a 3 meses; 6 meses "Holding Periods" ##########
##################################################################################################################
...
end_formation = start_formation + relativedelta(months=6)  # Dia de venta del portafolio
start_mesurement = start_formation - relativedelta(months=4)  # Primer dia de calculos de rendimientos.
...
print(f"Los activos con los menores retornos son:")
print('\n')
print(perdedores)
print('\n')
...
plt.legend()
plt.show()
cewrp_portafolio.to_csv(r'C:\Users\rumtl\PycharmProjects\Tesis\Momentum strategy\Estrategias\Retornos acumulados de las estrategias\3,6.csv')
### End ###