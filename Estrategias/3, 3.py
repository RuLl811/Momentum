...
##################################################################################################################
########### Cross-Sectional Momentum Strategy: Retornos rezagados a 3 meses; 3 meses "Holding Periods" ##########
##################################################################################################################
...
end_formation = start_formation + relativedelta(months=3)  # Dia de venta del portafolio
...
plt.legend()
plt.show()
cewrp_portafolio.to_csv(r'C:\Users\rumtl\PycharmProjects\Tesis\Momentum strategy\Estrategias\Retornos acumulados de las estrategias\3,3.csv')
### End ###