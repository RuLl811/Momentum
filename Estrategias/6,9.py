...
##################################################################################################################
########### Cross-Sectional Momentum Strategy: Retornos rezagados a 6 meses; 9 meses "Holding Periods" ##########
##################################################################################################################
...
end_formation = start_formation + relativedelta(months=9) - relativedelta(days=2) # Dia de venta del portafolio
...
SP500 = reader.DataReader('^GSPC', data_source='yahoo', start='2021-3-31', end='2021-12-29')['Adj Close']
...
plt.legend()
plt.show()
cewrp_portafolio.to_csv(r'C:\Users\rumtl\PycharmProjects\Tesis\Momentum strategy\Estrategias\Retornos acumulados de las estrategias\6,9.csv')
### End ###
