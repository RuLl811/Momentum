...
##################################################################################################################
########### Cross-Sectional Momentum Strategy: Retornos rezagados a 6 meses; 3 meses "Holding Periods" ##########
##################################################################################################################
...
plt.legend()
plt.show()
cewrp_portafolio.to_csv(r'C:\Users\rumtl\PycharmProjects\Tesis\Momentum strategy\Estrategias\Retornos acumulados de las estrategias\6,3.csv')
### End ###